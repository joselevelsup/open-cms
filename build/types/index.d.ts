...
export declare type CmsRoute = {
    name: string;
    apiRoute: string;
};
declare type CustomComponentFuncArgs = {
    onComponentChange(e: any): void;
    name: string;
};
declare type CustomComponentFunc = ({ onComponentChange, name }: CustomComponentFuncArgs) => React.ComponentType | JSX.Element;
