...
var Cms = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\twidth: 100%;\n\theight: 100%;\n\tbackground-color: ", ";\n"], ["\n\twidth: 100%;\n\theight: 100%;\n\tbackground-color: ", ";\n"])), function (props) { return props.theme.pageColor ? props.theme.pageColor : colors_1.pageColor; });
exports.Cms = Cms;
var CmsHeader = styled_components_1.default.div.attrs(function (props) { return ({
    logo: props.logo ? true : false
}); })(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n\tdisplay: flex;\n\tflex-direction: row;\n\tflex: 1;\n\tbackground-color: ", ";\n\t", "\n"], ["\n\tdisplay: flex;\n\tflex-direction: row;\n\tflex: 1;\n\tbackground-color: ", ";\n\t",
    "\n"])), function (props) { return props.theme.headerColor ? props.theme.headerColor : colors_1.headerColor; }, function (props) { return props.logo ? styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\t\t\tpadding: 6px 0;\n\t\t"], ["\n\t\t\tpadding: 6px 0;\n\t\t"]))) : styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\t\t\tpadding: 25px 10px;\n\t\t"], ["\n\t\t\tpadding: 25px 10px;\n\t\t"]))); });
